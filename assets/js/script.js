...
//pregunta 1
traumatologia.push(
    {hora: '9:00',  especialista: 'RENE POBLETE ', paciente: 'ANA GELLOMNA', rut: '13123329-7', prevision: 'ISAPRE'},
    {hora: '9:30',  especialista: 'MARIA SOLAR', paciente: 'RAMIRO ANDRADE',     rut: '12221451111-K', prevision: 'FONASA'},
...
//pregunta3
document.write(`<p>Pacientes Dental</p>`)
dental.forEach(function(paciente) {
    document.write(`<p>${paciente.hora} - ${paciente.especialista} - ${paciente.paciente} - ${paciente.rut} - ${paciente.prevision}</p>`);
});
document.write(`<br>`)

//pregunta4
document.write(`Todos los pacientes`)
var total_pacientes = radiologia.concat(traumatologia).concat(dental)
total_pacientes.forEach(function(paciente){
    document.write(`<p>${paciente.paciente}</p>`)
});
document.write(`<br>`)

//pregunta5
document.write(`Pacientes Dental con ISAPRE`)
dental.filter(function(paciente){
    if (paciente.prevision == "ISAPRE"){
        return document.write(`<p> ${paciente.paciente} - ${paciente.prevision} </p>`)
    }
});
document.write(`<br>`)

//prregunta6
document.write(`Pacientes Traumatologia con FONASA`)
traumatologia.filter(function(paciente){
